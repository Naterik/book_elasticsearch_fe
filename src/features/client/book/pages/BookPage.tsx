  ...
  return (
    <div className="w-full min-h-screen bg-gray-50">
      <div className="bg-white border-b border-gray-200">
        <div className="container p-2 mx-auto sm:py-3">
          <SearchBar
      ...
      <div className="container px-8 py-2 mx-auto sm:py-8">
        <div className="flex gap-2 mb-4 lg:hidden">
          <Sheet open={isFilterOpen} onOpenChange={setIsFilterOpen}>
            <SheetTrigger asChild>
              <Button
                variant="outline"
                className="gap-2 text-xs  sm:w-auto sm:text-sm"
                size="sm"
              >
            ...
            <SheetContent
              side="left"
              className="p-0 overflow-y-auto w-80 sm:w-96"
            >
              <SheetHeader className="sticky top-0 z-50 px-4 py-4 bg-white border-b sm:px-6">
